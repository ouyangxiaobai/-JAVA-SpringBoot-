...
public class UserServiceImpl implements UserService {
    ...
    public String uploadImg(MultipartFile file) throws IOException {
        ...
        // String parentPath = System.getProperty("user.dir") + "\\src\\main\\resources\\static\\upload\\projectImg";
        String parentPath = ResourceUtils.getURL("classpath:").getPath() + "static/upload/projectImg";

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String todayStr = sdf.format(new Date());
        File todayDir = new File(parentPath + "\\" + todayStr);
        ...
        File newFile = new File(todayDir + "\\" + fileName + fileType);

        FileUtils.copyInputStreamToFile(file.getInputStream(), newFile);
        String url = "/upload/projectImg/" + todayStr + "/" + fileName + fileType;
