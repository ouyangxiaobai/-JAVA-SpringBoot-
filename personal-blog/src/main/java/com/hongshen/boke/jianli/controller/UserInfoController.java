...
//            upload.mkdirs();
//        }
//        File copeFile = new File(path.getAbsolutePath(),"static/upload/drc.doc");
//        FileUtils.copyInputStreamToFile(file.getInputStream(), copeFile);
        ...
        if (!file.getOriginalFilename().endsWith(".doc") && !file.getOriginalFilename().endsWith(".docx")){
            return ResultResponse.failResponse(1, "请上传.doc或.docx格式的简历",null);
        }
        ...
        File path = new File(dirPath + "\\" + "jianli.doc");
